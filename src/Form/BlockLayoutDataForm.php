...
class BlockLayoutDataForm extends Form
{
    ...
    public function init()
    {
        ...
        $this->add([
            ...
            'options' => [
                'element_group' => 'block-layout-fieldset-constraints',
                'label' => 'Minimum width', // @translate
            ],
            'attributes' => [
                'id' => 'block-layout-data-min-width',
                'data-key' => 'min_width',
            ],
        ]);
        $this->add([
        ...
        $this->add([
            ...
            'options' => [
                'element_group' => 'block-layout-fieldset-constraints',
                'label' => 'Maximum height', // @translate
            ],
            'attributes' => [
                'id' => 'block-layout-data-max-height',
                'data-key' => 'max_height',
            ],
        ]);
        $this->add([
